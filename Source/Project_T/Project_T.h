...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnLoginPlayerDelegate, const APlayerController*);
DECLARE_MULTICAST_DELEGATE_OneParam(FOnLogoutPlayerDelegate, const APlayerController*);